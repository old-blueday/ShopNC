...
/*=================================订单列表============================*/
$language['admin_order_list']				= "订单列表";
...
/*=================================利润结算============================*/
$language['admin_order_month_pay_month']		= "月份";
$language['admin_order_month_pay_ben']			= "成本";
$language['admin_order_month_pay_sell']			= "销售额";
$language['admin_order_month_pay_cha']			= "利润";
$language['admin_order_month_pay_state']		= "利润分红结算状态";
$language['admin_order_month_pay_view']			= "查看";
$language['admin_order_month_pay_no']			= "否";
$language['admin_order_month_pay_payed']		= "主店已支付，等待子店确认收款中";
$language['admin_order_month_pay_conf_payed']	= "确认收款";
$language['admin_order_month_pay_trade_ok']		= "已结款";
$language['admin_order_month_pay_operate_ok']	= "操作成功";
/*=================================订单查看============================*/
