...
/**
 * FILE_NAME : admin_option.language.php   FILE_PATH : \shopnc6\language\zh_cn\admin_option.language.php
 * shopnc后台网店管理语言包
 *
...
/*=================================基本设置============================*/
$language['admin_system_basic_shop_name']		= '商店名称';
$language['admin_system_basic_host_name']		= '店主姓名';
$language['admin_system_basic_front_lang']		= '前台语言';
$language['admin_system_basic_back_lang']		= '后台语言';
$language['admin_system_basic_lang_add']		= '语言管理';
$language['admin_system_basic_sex']				= '性别';
$language['admin_system_basic_male']			= '男';
$language['admin_system_basic_female']			= '女';
$language['admin_system_basic_email']			= 'E-mail';
$language['admin_system_basic_money']			= '货币选择';
$language['admin_system_money_add']				= '货币管理';
$language['admin_system_basic_fax']				= '传真';
$language['admin_system_basic_editor']			= '编辑器选择';
$language['admin_system_basic_rich_text']		= '开启富文本编辑器';
$language['admin_system_basic_tel']				= '电话';
$language['admin_system_basic_shop_state']		= '网店状态';
$language['admin_system_basic_open']			= '开启';
$language['admin_system_basic_close']			= '关闭';
$language['admin_system_basic_select']			= '请选择';
$language['admin_system_basic_currencies']		= '对应货币';
$language['admin_system_basic_country']			= '国家地区';
$language['admin_system_basic_time_zone']		= '默认时区';
$language['admin_system_basic_address']			= '详细地址';
$language['admin_system_basic_zip_code']		= '邮编';
$language['admin_system_basic_copyright']		= '版权信息';
$language['admin_system_basic_icp']				= 'icp备案';
$language['admin_system_basic_logo']			= '网店LOGO';
$language['admin_system_basic_width']			= '宽';
$language['admin_system_basic_height']			= '高';
$language['admin_system_basic_keywords']		= '关键字';
$language['admin_system_basic_describe']		= '描述';

$language['admin_system_basic_save_ok']			= '基本设置保存成功';
$language['admin_system_basic_front_lang_null']	= '前台语言不能为空';
$language['admin_system_basic_back_lang_null']	= '后台语言不能为空';
$language['admin_system_basic_money_null']		= '货币选择不能为空';

/*=================================显示设置============================*/
$language['admin_system_display_index']			= '首页显示';
$language['admin_system_display_yes']			= '是';
$language['admin_system_display_no']			= '否';
$language['admin_system_display_num']			= '显示条数';
$language['admin_system_display_new']			= '最新商品显示';
$language['admin_system_display_special']		= '特价商品显示';
$language['admin_system_display_hot']			= '热卖商品显示';
$language['admin_system_display_commend']		= '推荐商品显示';
$language['admin_system_display_brand']			= '品牌显示';
$language['admin_system_display_subject']		= '主题显示';
$language['admin_system_display_vote']			= '投票显示';
$language['admin_system_display_post']			= '公告显示';

$language['admin_system_display_public']		= '公共设置';
$language['admin_system_display_more_lang']		= '显示多语言';
$language['admin_system_display_more_country']	= '显示多货币';
$language['amdin_system_display_cheap_price']	= '显示市场价';
$language['admin_system_display_balance']		= '显示差额';
$language['admin_system_display_buy']			= '商品直接购买';
$language['admin_system_display_fav']			= '商品直接收藏';
$language['admin_system_display_compact']		= '商品对比显示';
$language['admin_system_display_record']		= '浏览记录开启';
$language['admin_system_display_record_num']	= '浏览记录数';

$language['admin_system_validate']				= '验证码显示';
$language['admin_system_login_validate']		= '登录验证码显示';
$language['admin_system_user_reg_validate']		= '会员注册验证码显示';
$language['admin_system_provider_validate']		= '商家注册验证码显示';
$language['admin_system_admin_login_validate']	= '后台管理登录验证码显示';
$language['admin_system_comment_validate']		= '商品评论验证码显示';

$language['admin_system_display_others']		= '其他显示';
$language['admin_system_display_united']		= '统一设置';
$language['admin_system_display_single']		= '单独设置';
$language['admin_system_display_cate_num']		= '分类页显示商品数';
$language['admin_system_display_in_cate']		= '在分类列表中单独设置';
$language['admin_system_display_brand_num']		= '品牌页显示商品数';
$language['admin_system_display_in_brand']		= '在品牌列表中单独设置';
$language['admin_system_display_subject_num']	= '主题页显示商品数';
$language['admin_system_display_in_subject']	= '在主题列表页单独设置';

$language['admin_system_display_save_ok']		= '显示设置成功';
$language['admin_system_display_num_error']		= '必须填入数字';
$language['admin_system_display_num_min']		= '最小为1';
$language['admin_system_display_num_max']		= '最大为30';

/*=================================模板选取============================*/
$language['admin_system_theme_now_use']			= '当前使用模板';
$language['admin_system_theme_preview']			= '预览';
$language['admin_system_theme_apply']			= '应用';
$language['admin_system_theme_apply_ok']		= '模板选取成功';

/*=================================邮件设置============================*/
$language['admin_system_email_config']			= '参数设置';
$language['admin_system_email_type']			= '邮件发送类型';
$language['admin_system_email_use_mail']		= '系统内容mail发送';
$language['admin_system_email_use_smtp']		= '系统内容smtp发送';
...
$language['admin_system_email_new_user']		= '新会员注册';
$language['admin_system_email_buy_goods']		= '商品购买';
$language['admin_system_email_del_goods']		= '取消购买商品';
$language['admin_system_email_pay']				= '商品付款';
$language['admin_system_email_goods_send']		= '商品发货';
$language['admin_system_email_end']				= '交易结束';
...
$language['admin_user_add_time']				= "加入时间";
