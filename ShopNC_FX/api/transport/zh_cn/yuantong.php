...
/**
* FILE_NAME : yuantong.php D:\binzi\shopnc6\api\transport\zh_cn\yuantong.php
* 圆通配送
*
...
* @package 
* @subpackage 
* @version Thu Feb 05 15:27:08 CST 2009
*/
...
$transport_module[$i]['file']		= "yuantong";
$transport_module[$i]['name']		= "圆通配送";
$transport_module[$i]['info']		= "圆通配送说明";
