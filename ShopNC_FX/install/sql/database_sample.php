...
$database_config['dbprefix'] = '---dbprefix---';
...
##  dbcharset 数据库字符集
$database_config['dbcharset'] = '---dbcharset---';

##  dbcharset 数据库端口
$database_config['dbport'] 	  = '---dbport---';
#####################
## 设置写数据库信息  ##
#####################
##  servername_write=localhost 数据库服务器地址
$database_config['servername_write'] = '---dbhost---';

##  databasename_write=shopnc 数据库名称
$database_config['databasename_write'] = '---dbname---';

##  username_write=root 数据库用户名
$database_config['username_write'] = '---dbuser---';

##  password_write=root 数据库密码
$database_config['password_write'] = '---dbpasswd---';

#####################
## 设置读数据库信息  ##
#####################
##  servername_read=localhost 数据库服务器地址
$database_config['servername_read'] = '---dbhost---';

##  databasename_read=shopnc 数据库名称
$database_config['databasename_read'] = '---dbname---';

##  username_read=root 数据库用户名
$database_config['username_read'] = '---dbuser---';

##  password_read=root 数据库密
$database_config['password_read'] = '---dbpasswd---';
?>