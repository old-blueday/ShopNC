...
/**
* FILE_NAME : client.php D:\root\shopnc6_jh\uc_client\client.php
* uc_client
*
...
* @package 
* @subpackage 
* @version Sat Jul 04 10:43:43 CST 2009
*/
...
function uc_api_mysql($model, $action, $args=array()) {
	...
	if(empty($uc_controls[$model])) {
		include UC_ROOT.'./lib/db.class.php';
		include UC_ROOT.'./model/base.php';
		include UC_ROOT."./control/$model.php";
...
function uc_user_register($username, $password, $email,$userid='') {
	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>$username, 'password'=>$password, 'email'=>$email,'uid'=>$userid));
}
