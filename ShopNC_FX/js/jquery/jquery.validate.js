...
jQuery.extend(jQuery.validator, {
	...
	methods: {
		...
		ZIP: function(value, element) {
			return this.required(element) || /^[0-9][0-9]{5}$/.test(value);
		},

		Phone: function(value, element) {
			return this.required(element) || /^(([0\+]\d{2,3}-)?(0\d{2,3})-)?(\d{7,8})(-(\d{3,}))?$/.test(value);
		},
		Nozhcn: function(value, element) {
			return this.required(element) || /^[a-zA-Z0-9|\-|\_]+$/.test(value);
		},

		Mobile: function(value, element) {
			return this.required(element) || /^((\([0-9]{2,3}\))|([0-9]{3}\-))?1[0-9]{10}$/.test(value);
		},
		/**
