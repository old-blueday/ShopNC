	...
	<div class="yui-b">
		<div class="yui-g">
			<div class="y-middle">
				...
				<div class="nav">
					<ul>
                        <li class="nav-bg"><b></b><span><p><a href="own_message.php?action=newpm"><?php echo $lang['langMsgNew'];?></a></p></span></li>
				...
				<div class="z-mai-unite">
					...
					<table class="unite-table-1 unite-table-b"  border="0" cellspacing="0" cellpadding="0" >
						...
						<?php if(!empty($output['message_array']) && is_array($output['message_array'])){ ?>
							<?php foreach($output['message_array'] as $key=>$list){ ?>
								<tr class="tr-un-conter-1">
									...
									<td>
                                    <?php if($list['touid']) { ?>
										<a href="../../home/?<?php echo $list['msgfromid']; ?>"><img src="<?php echo UC_API; ?>/avatar.php?uid=<?php echo $list['msgfromid']; ?>&size=small" /><br/><?php echo $list['msgfrom'];?></a>
                                    <?php }else{ ?>
