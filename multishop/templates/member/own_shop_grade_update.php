			...
			<div class="y-middle">
				...
				<div class="cr-right">
					...
					<table width="100%" class="cr-r-td" border="0" cellpadding="0">
						<tr>
							<td class="cr-1Title" style="text-align:center;"><?php echo $lang['langGradeName']; ?></td>
						...
						<?php if ($val['grade_id'] != $output['shop_array']['shop_grade']) { ?>
						<tr>
							...
							<td class="cr-1list" style=" padding-left:22px;"><span class="buttom-comm"><input type="button" name="submit1" value="<?php echo $lang['langShopGradeUpdate']; ?>" onclick="if(confirm('<?php echo $lang['langShopGradeUpdateInfo']; ?>')) { window.location.href='own_shop.php?action=update_grade_save&shop_grade=<?php echo $val['grade_id']; ?>' }" /></span></td>
						</tr>
							<?php } ?>
						<?php } ?>
					</table>
