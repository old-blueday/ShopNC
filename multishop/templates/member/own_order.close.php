<div id="yui-main">
	<div class="yui-b">
		<div class="yui-g">
			<div class="y-middle">
				<div class="io-3">
					<p><?php echo $lang['langOrderClose']; ?></p>
				</div>
				<div class="clear-9"></div>			
				<div class="nav">
					<ul>			
						<li class="nav-bg"><b></b><span><p><?php echo $lang['langOrderClose'];?></p></span></li>
					</ul>
				</div>
				<form name="form1" action="own_order.php?action=close_save" method="post">
				...
				<div class="cr-right">
					<table width="100%" class="cr-r-td" border="0" cellpadding="0">
						...
						<tr>
							<td class="cr-1"><?php echo $lang['langOrderCloseReason']; ?>:</td>
							<td class="cr-2">
								<textarea name="close_reason" cols="40" rows="7"></textarea>	
            				</td>
						</tr>																		
					</table>
				</div>
