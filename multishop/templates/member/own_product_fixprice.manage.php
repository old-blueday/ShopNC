	...
	$('#recommended').click(
		function(){
			if(checkFormIn('recommended')){
				$('#form_product').attr("action", "own_product_fixprice.php?action=recommended");
				$('#form_product').submit();
			}
		}
	)
	$('#cancel_recommended').click(
		function(){
			if(checkFormIn('cancel_recommended')){
				$('#form_product').attr("action", "own_product_fixprice.php?action=cancel_recommended");
				$('#form_product').submit();
			}
		}
	)
    $('#store_recommended').click(
        function(){
			if(checkFormIn('store_recommended')){
				$('#form_product').attr('action','own_product_fixprice.php?action=store_recommended');
				$('#form_product').submit();
			}
        }
    )
    $('#cancel_store_recommended').click(
        function(){
			if(checkFormIn('cancel_store_recommended')){
				$('#form_product').attr('action','own_product_fixprice.php?action=cancel_store_recommended');
				$('#form_product').submit();
			}
        }
    )
