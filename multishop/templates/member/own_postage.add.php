<div id="yui-main">
	<div class="yui-b">
		<div class="yui-g">
			<div class="y-middle">
				<div class="io-3"><p><?php echo $lang['langPostageAdd'];?></p>
				</div>
				...
				<div class="nav">
					<ul>
						<li class="nav-bg"><b></b><span><p><?php echo $lang['langPostageAdd'];?></p></span></li>
					</ul>
				</div>
				<div class="cr-right">
				<form action="own_postage.php?action=save" method="post" id="form_postage">
					...
					<table width="100%" class="cr-r-td" border="0" cellpadding="0">
						<tr>
							...
							<td class="cr-2"><input type="text" name="postage_title" class="in-2" id="postage_title" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="cr-2"><textarea name="postage_content" id="postage_content" cols="50" rows="5"></textarea></td>
						</tr>
					</table>
					<div class="an-1">
...
<textarea style="display:none" id="area_input_template">
	<div>
		...
		<?php echo $lang['langPostageTo'];?><input type="text" class="quantity" id="{1}_area_text_{2}" onclick='edit_show_area("{1}",this,"{2}");' value="{0}" readonly /><?php echo $lang['langPostageToMoney'];?>:<input type="text" class="quantity_postage" name="{1}_area_postage_{2}" id="{1}_area_postage_{2}" value="" /><?php echo $lang['langCYuan'];?>,<?php echo $lang['langPostageSetUp'];?>:<input type="text" class="quantity_postage_up" name="{1}_area_postage_up_{2}" id="{1}_area_postage_up_{2}" value="0.0" /><?php echo $lang['langCYuan'];?> <br /><br /><a href="javascript:;" onclick="if(confirm('<?php echo $lang['langCConfirmDelete'];?>')){del_row(this);}else{return false;}"><?php echo $lang['langCdele'];?></a>
	</div>
</textarea>
<script>
// area array
