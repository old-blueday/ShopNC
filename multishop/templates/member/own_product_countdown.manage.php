	...
	$('#offsale').click(
		function(){
			if(checkFormIn('offsale')){
				$('#form_product').attr("action", "own_product_countdown_list.php?action=update_state");
				$('#form_product').submit();
			}
		}
	)
	$('#recommended').click(
		function(){
			if(checkFormIn('recommended')){
				$('#form_product').attr("action", "own_product_countdown_list.php?action=recommended");
				$('#form_product').submit();
			}
		}
	)
	$('#cancel_recommended').click(
		function(){
			if(checkFormIn('cancel_recommended')){
				$('#form_product').attr("action", "own_product_countdown_list.php?action=cancel_recommended");
				$('#form_product').submit();
			}
		}
	)
    $('#store_recommended').click(
        function(){
			if(checkFormIn('store_recommended')){
				$('#form_product').attr('action','own_product_countdown_list.php?action=store_recommended');
				$('#form_product').submit();
			}
        }
    )
    $('#cancel_store_recommended').click(
        function(){
			if(checkFormIn('cancel_store_recommended')){
				$('#form_product').attr('action','own_product_countdown_list.php?action=cancel_store_recommended');
				$('#form_product').submit();
			}
        }
    )
			...
			<div class="y-middle">
				...
				<div class="nav">
					<ul>
						...
						<li class="nav-bg nav-left"><b></b><span><p><?php echo $lang['langPCountdownList'];?></p></span></li>
					</ul>
				</div>
				<div class="z-mai-unite">
					<table class="unite-table-1"  border="0" cellspacing="0" cellpadding="0" >
						<tr class="tr-un-bg-2">
							...
							<td style="width:25%;"><?php echo $lang['langProductMName']; ?></td>
							<td style="width:10%;"><?php echo $lang['langProductMNum']; ?></td>
							<td style="width:10%;"><?php echo $lang['langPPriceSorE']; ?></td>
							<td style="width:10%;"><?php echo $lang['langProductAddTime']; ?></td>
							<td style="width:10%;"><?php echo $lang['langProductStartTime']; ?></td>
							<td style="width:10%;"><?php echo $lang['langProductEndTime']; ?></td>
							<td style="width:10%;"><?php echo $lang['langCedit']; ?></td>
						</tr>
