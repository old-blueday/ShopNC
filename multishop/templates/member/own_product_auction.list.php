	...
	$('#offsale').click(
		function(){
			if(checkFormIn('offsale')){
				$('#form_product').attr("action", "own_product_auction.php?action=offsale");
				$('#form_product').submit();
			}
		}
	)
	$('#recommended').click(
		function(){
			if(checkFormIn('recommended')){
				$('#form_product').attr("action", "own_product_auction.php?action=recommended");
				$('#form_product').submit();
			}
		}
	)
	$('#cancel_recommended').click(
		function(){
			if(checkFormIn('cancel_recommended')){
				$('#form_product').attr("action", "own_product_auction.php?action=cancel_recommended");
				$('#form_product').submit();
			}
		}
	)
    $('#store_recommended').click(
        function(){
			if(checkFormIn('store_recommended')){
				$('#form_product').attr('action','own_product_auction.php?action=store_recommended');
				$('#form_product').submit();
			}
        }
    )
    $('#cancel_store_recommended').click(
        function(){
			if(checkFormIn('cancel_store_recommended')){
				$('#form_product').attr('action','own_product_auction.php?action=cancel_store_recommended');
				$('#form_product').submit();
			}
        }
    )
	...
	<div class="yui-b">
		<div class="yui-g">
			<div class="y-middle">
				...
				<div class="sos">
					<form action="own_product_auction.php?action=list" method="post"  name="search_form">
						<ul>
				...
				<div class="z-mai-unite">
					<table class="unite-table-1"  border="0" cellspacing="0" cellpadding="0" >
						<tr class="tr-un-bg-2">
							...
							<td class="td-bg-3" style="width:10%;">
								<?php echo $lang['langOldPrice']; ?>/<?php echo $lang['langPHNoncePrice']; ?>
							</td>
						...
						<tr class="tr-un-conter-4">
							...
							<td class="tr-img">
								...
								<span class="depott-span-31">
									...
									<p class="depott-p-2">(<?php echo $lang['langPauction'];?>)</p>
