<div id="yui-main">
	<div class="yui-b">
		<div class="yui-g">
			<div class="y-middle">
				<div class="io-3">
					<p><?php echo $lang['langOrderConfirmPay'];?></p>
				</div>
				<div class="clear-9"></div>			
				<div class="nav">
					<ul>			
						<li class="nav-bg"><b></b><span><p><?php echo $lang['langOrderConfirmPay'];?></p></span></li>
					</ul>
				</div>
				<form action="own_order.php?action=save_predeposit_pay" method="post">
