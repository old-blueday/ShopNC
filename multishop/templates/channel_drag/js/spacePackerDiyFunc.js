...
function initBackgroundImage() {
    ...
    getpage(1, "channel.php?action=getSysPic&type=" + backgroundType + "&inajax=1");
}
...
function changeSysBackground(obj, param, picNav) {
    ...
    getpage(1, "channel.php?action=getSysPic&type=" + backgroundType + colorParam + "&inajax=1" + param);
...
function switchStyle(styleId, myType) {
    ...
    var myurl = "channel.php?action=myStyle&op=getCss&type=" + myType;
    if (myType == "fastDiy") {
...
callbackMyStyles.prototype.complete = function(obj) {
    getStyleList("channel.php?action=myStyle");
};
callbackMyStyles.prototype.close = function(obj) {
    if ($("selectMyStyle").value > 0) {
        window.location.href = "channel.php?action=myStyle&op=use&styleId=" + $("selectMyStyle").value;
    } else {
...
callbackSelectShare.prototype.complete = function(obj) {
    ...
    getpage(1, "channel.php?action=getShareStyle&type=" + backgroundType + "&colorId=" + tplColorId + "&inajax=1");
};
...
callbackSetBlock.prototype.complete = function(obj) {
    ...
    titleHeight = titleHeight / 60 * 100;
