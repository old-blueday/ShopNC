...
//必填参数
$out_trade_no = $array['predeposit_r_id'];			//请与贵网站订单系统中的唯一订单号匹配
$subject      = $array['subject'];		//订单名称，显示在支付宝收银台里的“商品名称”里，显示在支付宝的交易管理的“商品名称”的列表里。
$body         = $array['body'];		//订单描述、订单详细、订单备注，显示在支付宝收银台里的“商品描述”里
$total_fee    = $array['online_amount'];		//订单总金额，显示在支付宝收银台里的“应付总额”里
...
$exter_invoke_ip = '';				//买家本地电脑的IP地址
if($antiphishing == 1){
    $encrypt_key = query_timestamp($partner);
	$exter_invoke_ip = '';			//填写上买家本地电脑的IP地址
}
