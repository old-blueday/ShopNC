                ...
                var     lineW=_this.find("li:first").width(), //获取列表宽度
                        line=opt.line?parseInt(opt.line,10):parseInt(this.width()/lineW,10), //每次滚动的行数，默认为一屏，即父容器高度                                                
								...
								var scrollRight=function(){                        
								        _BtnRight.unbind("click",scrollLeft); //Shawphy:取消向右按钮的函数绑定                        
								        _this.animate({                                
								                marginLeft:rightWidth
												        ...
												        _BtnRight.bind("click",scrollLeft); //Shawphy:绑定向右按钮的点击事件                        
												});                 
								}                
								//Shawphy:向左翻页函数                
								...
								_BtnRight.css("cursor","pointer").click( scrollLeft ).hover(autoStop,autoPlay);//Shawphy:向左向右鼠标事件绑定                
