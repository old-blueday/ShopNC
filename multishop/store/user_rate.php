...
/**
 * FILE_NAME : user_rate.php   FILE_PATH : \multishop\store\user_rate.php
 * ....信誉分显示
 *
...
class StoreRate extends StoreFrameWork{
	/**
	 * 评价对象
	 *
	 * @var obj
	...
	function main(){
		...
		if($this->shop['templates'] == '0'){
			$this->showpage("store_user_rate.default");
		}else{
			//自定义风格内容
			$this->_get_diy_style();

			$this->showpage("store_user_rate");
		}
